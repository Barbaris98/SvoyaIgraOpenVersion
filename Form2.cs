    ...
    public partial class Form2 : Form
    {
        public Form2()
        {
            ...
            using (SqliteConnection connection = new SqliteConnection(connectionString))
            {
                ...
                string commandString = "SELECT QuestionText FROM Question WHERE IdQuestion = 1;";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqliteConnection connection = new SqliteConnection(connectionString))
            {
                ...
                string commandString = "SELECT Answer FROM Question WHERE IdQuestion = 1;";
                SqliteCommand sqlCommand = new SqliteCommand(commandString, connection);
        ...
        // ЗАГРЕИВАНИЕ ПОСЛЕ ПРИСВОЕНИЯ ОДНОГО ОЧКА и закрытие
        private void button2_Click(object sender, EventArgs e)//1 -я команда
        {
        ...
        private void button3_Click(object sender, EventArgs e)//2 -я команда
        {
        ...
        private void button4_Click(object sender, EventArgs e)//3 -я команда
        {
